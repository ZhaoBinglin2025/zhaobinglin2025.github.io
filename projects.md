  ...
  <div class="pub">
    ...
    <div class="body">
      ...
      <p>
        ...
        我设计并开发了一个<strong>3D 游戏化实验系统</strong>，旨在保持实验效度的同时提高参与度。该系统基于<strong>情景记忆偏差</strong>理论，模拟记忆处理中<strong>模式分离与模式补全</strong>的交互。情景记忆偏差理论已有其本身的研究范式，被试需要通过交互快速将刺激分类为新颖、重复或相似。可点击左侧海报进行demo的试玩。
      </p>
    </div>
  </div>
